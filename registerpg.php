...
<li><a href="bloodfind.php">Find Blood</a></li>
...
<div class="row">
	<div class="col-xs-12 col-sm-9">
		...
		<h2>Blood needer registration Form</h2>
<div class="first">
		
		<form id="register-form" action="my.php" method="POST">				
			<div class="form">
			<table class="table">
				<tbody><tr>
...
<option value="O-">O-</option>
				...
				<tr>
					<td width="35%"><label for="Users_dateofbirth">Date of Birth</label></td>
					<td><input size="10" maxlength="10" class="form-control hasDatepicker" id="Users_dateofbirth" name="dob" type="date"></td>
				</tr>
				<tr>
